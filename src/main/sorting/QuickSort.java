...
/**
 * A generic QuickSort implementation for main.sorting arrays of any type that implements {@link Comparable}.
 * This class provides an in-place, recursive main.sorting algorithm with average-case time complexity of O(n log n).
 * ----------------------------------------------------------------------
