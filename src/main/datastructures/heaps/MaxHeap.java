...
/**
 * MaxHeap implementation using a binary heap with an array.
 * Supports insertion, deletion of the maximum element, and basic heap operations.
...
public class MaxHeap<Key extends Comparable<Key>> {
    ...
    /**
     * Initializes an empty max-heap with the specified initial capacity.
     ...
     * @return true if pq[i] is less than pq[j], false otherwise
     * Time complexity: O(1)
     */
